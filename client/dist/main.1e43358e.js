...
var _default = {
  ...
  methods: {
    ...
    registerHandler: function registerHandler() {
      ...
      _axios.default.post('https://kanban-app-projects.herokuapp.com/register', {
        email: this.email,
...
exports.default = _default;
        var $4bae39 = exports.default || module.exports;
      
      if (typeof $4bae39 === 'function') {
        $4bae39 = $4bae39.options;
      }
    
        /* template */
        Object.assign($4bae39, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container add-form" }, [
    _c("h1", [_vm._v("Register Account")]),
    _vm._v(" "),
    _c(
      "form",
      {
        ...
        on: {
          submit: function($event) {
            ...
            return _vm.registerHandler($event)
          }
        }
      },
      [
        ...
        _c(
          "button",
          {
            staticClass: "btn btn-danger btn-back",
            on: {
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4bae39', $4bae39);
          } else {
            api.reload('$4bae39', $4bae39);
          }
        }
...
var _default = {
  ...
  data: function data() {
    return {
      ...
      password: "",
      params: {
        client_id: "321191066324-10iavk72tkhqsovavovuuucnt823u6np.apps.googleusercontent.com"
      },
  ...
  methods: {
    loginHandler: function loginHandler() {
      ...
      _axios.default.post("https://kanban-app-projects.herokuapp.com/login", {
        email: this.email,
        password: this.password
      }).then(function (_ref) {
        var data = _ref.data;
    ...
    onSuccess: function onSuccess(googleUser) {
      ...
      _axios.default.post("https://kanban-app-projects.herokuapp.com/googleLogin", {
...
exports.default = _default;
        var $41dbaf = exports.default || module.exports;
      
      if (typeof $41dbaf === 'function') {
        $41dbaf = $41dbaf.options;
      }
    
        /* template */
        Object.assign($41dbaf, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$41dbaf', $41dbaf);
          } else {
            api.reload('$41dbaf', $41dbaf);
          }
        }
...
exports.default = _default;
        var $904251 = exports.default || module.exports;
      
      if (typeof $904251 === 'function') {
        $904251 = $904251.options;
      }
    
        /* template */
        Object.assign($904251, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      ...
      _c("form", { staticClass: "form-inline" }, [
        _c(
          "button",
          {
            staticClass: "btn btn-outline-danger my-2 my-sm-0 logout",
            attrs: { type: "submit", params: _vm.params, logoutButton: true },
            on: {
              click: function($event) {
                $event.preventDefault()
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$904251', $904251);
          } else {
            api.reload('$904251', $904251);
          }
        }
...
var _default = {
  ...
  props: ["task"],
  methods: {
    editForm: function editForm(task) {
      this.$emit("changePage", "editTaskForm"); // this.$emit("editMe", task);
    },
    deleteHandler: function deleteHandler(param) {
      this.$store.dispatch("deleteHandler", param);
    },
    moveHandlerLeft: function moveHandlerLeft(param1, param2) {
      if (param2 == "done") {
        param2 = "doing";
    ...
    moveHandlerRight: function moveHandlerRight(param1, param2) {
      if (param2 == "backlog") {
        param2 = "todo";
      } else if (param2 == "todo") {
        param2 = "doing";
...
exports.default = _default;
        var $258c7e = exports.default || module.exports;
      
      if (typeof $258c7e === 'function') {
        $258c7e = $258c7e.options;
      }
    
        /* template */
        Object.assign($258c7e, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "card border-success" }, [
    _c("div", { staticClass: "card-body" }, [
      _c("h5", [_vm._v(_vm._s(_vm.task.title))]),
      _vm._v(" "),
      _vm.task.category == "backlog"
        ? _c("button", {
            staticClass: "btn btn-primary fa fa-info",
            staticStyle: { "font-size": "20px" },
            on: {
              click: function($event) {
                $event.preventDefault()
                return _vm.editForm(_vm.task)
              }
            }
          })
        : _vm._e(),
      ...
      _vm.task.category !== "backlog"
        ? _c("button", {
            staticClass: "btn btn-primary fa fa-arrow-left",
            staticStyle: { "font-size": "20px" },
            attrs: { type: "button" },
            on: {
              click: function($event) {
                $event.preventDefault()
                return _vm.moveHandlerLeft(_vm.task.id, _vm.task.category)
              }
            }
          })
        : _vm._e(),
      _vm._v(" "),
      _c("button", {
        staticClass: "btn btn-danger fa fa-trash",
        staticStyle: { "font-size": "20px" },
        attrs: { type: "button" },
        on: {
          click: function($event) {
            $event.preventDefault()
            return _vm.deleteHandler(_vm.task.id)
          }
        }
      }),
      _vm._v(" "),
      _vm.task.category !== "done"
        ? _c("button", {
            staticClass: "btn btn-success fa fa-arrow-right",
            staticStyle: { "font-size": "20px" },
            attrs: { type: "button" },
            on: {
              click: function($event) {
                $event.preventDefault()
                return _vm.moveHandlerRight(_vm.task.id, _vm.task.category)
              }
            }
          })
        : _vm._e()
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$258c7e', $258c7e);
          } else {
            api.reload('$258c7e', $258c7e);
          }
        }
...
exports.default = _default;
        var $bb4614 = exports.default || module.exports;
      
      if (typeof $bb4614 === 'function') {
        $bb4614 = $bb4614.options;
      }
    
        /* template */
        Object.assign($bb4614, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _vm.category === "backlog"
      ? _c(
          "div",
          {
            staticClass: "card border-secondary mb-3 w-100",
          ...
          [
            ...
            _c(
              "div",
              {
                ...
                staticStyle: { "max-height": "18rem" }
              },
              _vm._l(_vm.allDatas.backlog, function(task) {
                return _c("TaskTitle", {
                  key: task.id,
                  attrs: { task: task },
                  on: {
                    changePage: _vm.changePage,
                    refetchTask: _vm.refetchTask,
                    editMe: _vm.editMe
                  }
                })
              }),
      ...
      ? _c(
          ...
          [
            ...
            _c(
              ...
              _vm._l(_vm.allDatas.todo, function(task) {
                return _c("TaskTitle", {
                  key: task.id,
                  attrs: { task: task },
                  on: { refetchTask: _vm.refetchTask, editMe: _vm.editMe }
                })
              }),
              1
            )
      ...
      ? _c(
          ...
          [
            ...
            _c(
              ...
              _vm._l(_vm.allDatas.doing, function(task) {
                return _c("TaskTitle", {
                  key: task.id,
                  attrs: { task: task },
                  on: { refetchTask: _vm.refetchTask, editMe: _vm.editMe }
      ...
      ? _c(
          ...
          [
            ...
            _c(
              ...
              _vm._l(_vm.allDatas.done, function(task) {
                return _c("TaskTitle", {
                  key: task.id,
                  attrs: { task: task },
                  on: { refetchTask: _vm.refetchTask, editMe: _vm.editMe }
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bb4614', $bb4614);
          } else {
            api.reload('$bb4614', $bb4614);
          }
        }
...
},{"./TaskTitle":"src/components/TaskTitle.vue","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Task.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $d32c9f = exports.default || module.exports;
      
      if (typeof $d32c9f === 'function') {
        $d32c9f = $d32c9f.options;
      }
    
        /* template */
        Object.assign($d32c9f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c(
      "div",
      { staticClass: "container contain" },
      _vm._l(_vm.categories, function(category, index) {
        return _c("TaskCard", {
          key: index,
          attrs: { task: _vm.task, category: category },
          on: {
            refetchTask: _vm.refetchTask,
            editMe: _vm.editMe,
            changePage: _vm.changePage
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d32c9f', $d32c9f);
          } else {
            api.reload('$d32c9f', $d32c9f);
          }
        }
...
},{"./Navbar":"src/components/Navbar.vue","./TaskCard":"src/components/TaskCard.vue","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/AddTaskForm.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    addTaskHandler: function addTaskHandler() {
      var _this = this;
      ...
      _axios.default.post("http://localhost:3000/tasks", {
        ...
        _this.$emit('refetchTask');
      }).catch(function (err) {
        console.log(err);
      }).then(function () {
        _this.title = "";
        _this.category = "backlog";
      });
    },
...
exports.default = _default;
        var $a87e34 = exports.default || module.exports;
      
      if (typeof $a87e34 === 'function') {
        $a87e34 = $a87e34.options;
      }
    
        /* template */
        Object.assign($a87e34, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      _c(
        "form",
        {
          ...
          on: {
            submit: function($event) {
              $event.preventDefault()
              return _vm.addTaskHandler($event)
            }
          }
        },
        [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a87e34', $a87e34);
          } else {
            api.reload('$a87e34', $a87e34);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/EditTaskForm.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    editHandler: function editHandler() {
      ...
      _axios.default.put("https://kanban-app-projects.herokuapp.com/tasks/".concat(this.tampEdit.id), {
        title: this.title,
        category: this.category
      }, {
        headers: {
...
exports.default = _default;
        var $ce3f39 = exports.default || module.exports;
      
      if (typeof $ce3f39 === 'function') {
        $ce3f39 = $ce3f39.options;
      }
    
        /* template */
        Object.assign($ce3f39, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ce3f39', $ce3f39);
          } else {
            api.reload('$ce3f39', $ce3f39);
          }
        }
...
var _EditTaskForm = _interopRequireDefault(require("./components/EditTaskForm"));
...
exports.default = _default;
        var $3e2603 = exports.default || module.exports;
      
      if (typeof $3e2603 === 'function') {
        $3e2603 = $3e2603.options;
      }
    
        /* template */
        Object.assign($3e2603, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm.isPage == "login"
        ? _c("LoginForm", { on: { changePage: _vm.changePage } })
        : _vm.isPage == "register"
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.isPage == "editTaskForm",
            expression: "isPage == 'editTaskForm'"
          }
        ],
        attrs: { tampEdit: _vm.tampEdit },
        on: { changePage: _vm.changePage, refetchTask: _vm.fetchCard }
      })
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3e2603', $3e2603);
          } else {
            api.reload('$3e2603', $3e2603);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./components/RegisterForm":"src/components/RegisterForm.vue","./components/LoginForm":"src/components/LoginForm.vue","./components/Task":"src/components/Task.vue","./components/Navbar":"src/components/Navbar.vue","./components/AddTaskForm":"src/components/AddTaskForm.vue","./components/EditTaskForm":"src/components/EditTaskForm.vue","_css_loader":"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/vuex/dist/vuex.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
var _default = index;
exports.default = _default;
},{}],"src/axios/axiosInstance.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"axios":"node_modules/axios/index.js"}],"src/store/index.js":[function(require,module,exports) {
"use strict";
...
var _default = new _vuex.default.Store({
  ...
  mutations: {
    FETCH_DATA: function FETCH_DATA(state, payload) {
  ...
  actions: {
    fetchData: function fetchData(_ref) {
      ...
      _axiosInstance.default.get('/tasks', {
        headers: {
          access_token: localStorage.getItem('access_token')
        }
      }).then(function (_ref2) {
    ...
    deleteHandler: function deleteHandler(_ref3, payload) {
      var dispatch = _ref3.dispatch;

      _axiosInstance.default.delete("/tasks/".concat(payload), {
        headers: {
          access_token: localStorage.getItem('access_token')
        }
      }).then(function (_ref4) {
    ...
    patchHandler: function patchHandler(_ref5, payload) {
      var dispatch = _ref5.dispatch;

      _axiosInstance.default.patch("/tasks/".concat(payload.id), {
...
exports.default = _default;
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","vuex":"node_modules/vuex/dist/vuex.esm.js","../axios/axiosInstance":"src/axios/axiosInstance.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","./store":"src/store/index.js"}],"../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
